...
public class MainMenu {
    ...
    private void createBoard() throws SQLException {
        ...
        System.out.println("Seu board tera colunas alem das 3 padroes ? caso sim informe quantas, se nao, digite '0'");
        ...
        for (int i = 0; i < additionalColumns; i++) {
            System.out.println("Informe o nome da coluna de tarefas pendente");
